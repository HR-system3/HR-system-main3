...
export default function CreateUserPage() {
  ...
  useEffect(() => {
    // Allow System Admin and HR Manager to create users
    ...
    if (!isSystemAdmin && !isHrManager) {
      setError('You do not have permission to create users. Only System Admins or HR Managers can access this page.');
    }
  }, [user]);
  ...
  if (!isSystemAdmin && !isHrManager) {
    return (
      <div className="max-w-4xl mx-auto">
        <ErrorMessage message="You do not have permission to create users. Only System Admins or HR Managers can access this page." />
