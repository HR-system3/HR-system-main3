...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect based on role or to attendance page
      ...
      if (error.isNetworkError || !error.response) {
        ...
        // Handle API errors
        const errorMessage = error?.response?.data?.message || error?.userMessage || 'Login failed. Please check your credentials.';
