...
@Module({
  imports: [
    ...
    MongooseModule.forFeature([
      ...
      { name: allowance.name, schema: allowanceSchema },          // ✅ allowance
      { name: payGrade.name, schema: payGradeSchema },            // ✅ payGrade
      { name: taxRules.name, schema: taxRulesSchema },            // ✅ taxRules
      { name: insuranceBrackets.name, schema: insuranceBracketsSchema }, // ✅ insuranceBrackets
      { name: EmployeeProfile.name, schema: EmployeeProfileSchema }, // ✅ EmployeeProfile
    ]),
  ],
