...
interface ResignationBenefitsTableProps {
  benefits: Benefit[];
  onApprove: (id: string) => Promise<void>;
}

export default function ResignationBenefitsTable({ benefits, onApprove }: ResignationBenefitsTableProps) {
  if (benefits.length === 0) {
    return <p className="text-sm text-gray-500">No resignation benefits found</p>;
  }
