...
export default function ManagerApprovalPanel({ runId, onApprove, onReject }: ManagerApprovalPanelProps) {
  ...
  return (
    <div className="border border-gray-200 rounded-lg p-4 bg-white">
      <h3 className="text-lg font-semibold text-gray-900 mb-4">Manager Approval</h3>
